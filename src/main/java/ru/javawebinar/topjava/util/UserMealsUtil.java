...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        for (UserMeal um : meals) {
            caloriesSumByDay.merge(um.getDateTime().toLocalDate(), um.getCalories(), Integer::sum);
        }
        List<UserMealWithExcess> mealsTo = new ArrayList<>();
        for (UserMeal um : meals) {
            LocalDateTime ldt = um.getDateTime();
            if (TimeUtil.isBetweenHalfOpen(ldt.toLocalTime(), startTime, endTime)) {
                mealsTo.add(new UserMealWithExcess(ldt, um.getDescription(),
                        um.getCalories(), caloriesSumByDay.get(ldt.toLocalDate()) > caloriesPerDay));
            }
        }
    ...
    public static List<UserMealWithExcess> filteredByStreams(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        HashMap<LocalDate, Integer> caloriesSumByDay = (HashMap<LocalDate, Integer>) meals
                .stream()
        ...
        return meals
                ...
                .map(um -> new UserMealWithExcess(um.getDateTime(), um.getDescription(),
                        um.getCalories(), caloriesSumByDay.get(um.getDateTime().toLocalDate()) > caloriesPerDay))
